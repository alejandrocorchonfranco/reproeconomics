...
All variables were harmonised to annual frequency and aligned by calendar year. The analytical sample covers Spain, 1976–2022. Missing observations in macroeconomic controls were not imputed and were excluded from specifications requiring those controls. :contentReference[oaicite:1]{index=1}
